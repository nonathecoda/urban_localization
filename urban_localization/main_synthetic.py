...
if __name__ == "__main__":
    ...
    def initialisation():
        ...
        query_pose = PoseEstimate.create_from_scene(scene, camera, query_pose_hilla, name = 'query_pose')
        ...
        guessed_pose = PoseEstimate.create_from_scene(scene, camera, guessed_pose_hilla, name = 'guessed_pose')
